...
class module_monomial
{
  ...
  inline const monom& m() const { return myMon; }

  inline int idx () const { return myIdx; }

  inline const monom& wm() const { return myWeightedMon; }

  inline int wd() const { return myWeightedDegree; }

  inline bool isDivisibleBy (const module_monomial& m) const
  {
...
std::ostream& operator<< (std::ostream& o,
                          const module_monomial<monom, module_ordering>& m)
{
  m.print (o);
  return o;
}
